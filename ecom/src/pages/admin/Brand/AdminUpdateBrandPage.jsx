        ...
        <div className="container-fluid mt-2">
                    <div className="row">
                        ...
                        <div className="col-md-9">
                            <h5 className='mybackground text-light text-center p-2 mb-3 mt-1'>Create Brand
                                <Link to="/admin/brand"><i className='bi bi-arrow-left text-light fs-1 float-end mt-2 '></i></Link>
                            </h5>
                            <form onSubmit={postData}>
                                <div className="row">
                                    ...
                                    <div className="col-12 mb-5">
                                        <input type="text" name='name' value={data.name} placeholder='Brand name' onChange={getInputData} className={`form-control ${show && errormessage.name? "border-danger":"myborder"}`} />
