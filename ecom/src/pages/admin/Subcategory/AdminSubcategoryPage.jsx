            ...
            <div className="container-fluid my-3">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='mybackground text-light text-center p-2'>Sub Category
                            <Link to="/admin/subcategory/create"><i className='bi bi-plus text-light fs-1 float-end mt-2 '></i></Link>
                        </h5>
                                ...
                                <tbody>
                                    {data.map(item => {
                                        return <tr key={item.id}>
                                            ...
                                            <td>
                                                <Link to={`/admin/subcategory/update/${item.id}`} className='btn btn-primary mybackground'>
