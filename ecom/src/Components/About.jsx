                ...
                <div className="row align-items-center gy-5">
                    <div className="col-lg-6">
                        <div className="about-img" data-aos="fade-right">
                            <img src="/images/logos/logo-dark.png" alt="img"/>
                        </div>
                    </div>
                    <div className="col-lg-6">
                            ...
                            <div className="about-list">
                                <ul>
                                    <li>
                                        ...
                                        <p>Quality-focused and fairly priced items</p>
                                    </li>
                                    <li>
                                        <span>
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                        ...
                                        <p>Clean, easy, and smooth shopping experience</p>
                                    </li>
                                    <li>
                                        <span>
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                        ...
                                        <p>Designed for modern, everyday shoppers</p>
                                    </li>
                                </ul>
                            </div>
                            <Link to="/contact" className="shop-btn w-100">
                                Contact us
                                <span>
