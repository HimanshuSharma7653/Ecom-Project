            ...
            <div className="category-section">
                <div className="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                    ...
                    <div className="wrapper-info">
                        <a href="product-sidebar.html" className="wrapper-details">Dresses</a>
                    </div>
                </div>
                <div className="product-wrapper" data-aos="fade-right" data-aos-duration="200">
                    ...
                    <div className="wrapper-info">
                        <a href="product-sidebar.html" className="wrapper-details">Leather Bags</a>
                    </div>
                </div>
                <div className="product-wrapper" data-aos="fade-right" data-aos-duration="300">
                    ...
                    <div className="wrapper-info">
                        <a href="product-sidebar.html" className="wrapper-details">Sweaters</a>
                    </div>
                </div>
                <div className="product-wrapper" data-aos="fade-right" data-aos-duration="400">
                    ...
                    <div className="wrapper-info">
                        <a href="product-sidebar.html" className="wrapper-details">Boots</a>
                    </div>
                </div>
                <div className="product-wrapper" data-aos="fade-right" data-aos-duration="500">
                    ...
                    <div className="wrapper-info">
                        <a href="product-sidebar.html" className="wrapper-details">Gift for Him</a>
                    </div>
                </div>
                <div className="product-wrapper" data-aos="fade-right" data-aos-duration="600">
                    ...
                    <div className="wrapper-info">
                        <a href="product-sidebar.html" className="wrapper-details">Sneakers</a>
                    </div>
                </div>
                <div className="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                    <div className="wrapper-img">
                    ...
                    <div className="wrapper-info">
                        <a href="product-sidebar.html" className="wrapper-details">Watch</a>
                    </div>
                </div>
                <div className="product-wrapper" data-aos="fade-right" data-aos-duration="200">
                    <div className="wrapper-img">
                    ...
                    <div className="wrapper-info">
                        <a href="product-sidebar.html" className="wrapper-details">Gold Rings</a>
                    </div>
                </div>
                <div className="product-wrapper" data-aos="fade-right" data-aos-duration="300">
                    <div className="wrapper-img">
                    ...
                    <div className="wrapper-info">
                        <a href="product-sidebar.html" className="wrapper-details">Cap</a>
                    </div>
                </div>
                <div className="product-wrapper" data-aos="fade-right" data-aos-duration="400">
                    <div className="wrapper-img">
                    ...
                    <div className="wrapper-info">
                        <a href="product-sidebar.html" className="wrapper-details">Sunglass</a>
                    </div>
                </div>
                <div className="product-wrapper" data-aos="fade-right" data-aos-duration="500">
                    <div className="wrapper-img">
                    ...
                    <div className="wrapper-info">
                        <a href="product-sidebar.html" className="wrapper-details">Baby Shop</a>
                    </div>
                </div>
                <div className="product-wrapper" data-aos="fade-right" data-aos-duration="200">
                    <div className="wrapper-img">
