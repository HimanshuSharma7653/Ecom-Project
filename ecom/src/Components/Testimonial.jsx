            ...
            <Swiper className="mySwiper" {...sliderOptions}>
              <SwiperSlide>
                <div className="testimonial-wrapper">
                  ...
                  <p className="testimonial-details">
                    enean ullamcorper at magna et in to
                    <span className="testimonial-inner-text">
                      the a iaculis. Mauris mattis ac diam
                    </span>{" "}
                    a ultricies. Sed pretium.
                  </p>
              ...
              <SwiperSlide>
                <div className="testimonial-wrapper">
                  ...
                  <p className="testimonial-details">
                    Almost every imaginable design is possible and
                    customizations are allowed on every level. Some features
                    could make use of better controls. If you know how to
                    operate your mouse, then you are all set to use this
                    pagebuilder.
                  </p>
                  <div className="ratings">
                    <span>
              ...
              <SwiperSlide>
                <div className="testimonial-wrapper">
                  ...
                  <p className="testimonial-details">
                    ...
                    we see are websites not optimized for SEO because of old,
                    boring, or out of date website themes or designs.
                  </p>
                  <div className="ratings">
                    <span>
                      <svg
                ...
                <div className="testimonial-wrapper">
                  ...
                  <div className="testimonial-info">
                    ...
                    <div className="testimonial-info-details">
                      ...
                      <p className="testimonial-title">
                        Designer of{" "}
                        <span className="title-inner">DesginCode</span>
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <SwiperSlide>
                <div className="testimonial-wrapper">
                  ...
                  <p className="testimonial-details">
                    Build the perfect online store using our high-converting
                  ...
                  <div className="testimonial-info">
                    ...
                    <div className="testimonial-info-details">
                      ...
                      <p className="testimonial-title">
                        Ceo of <span className="title-inner">DesginLab</span>
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <SwiperSlide>
                <div className="testimonial-wrapper">
                  ...
                  <p className="testimonial-details">
                    The lightweight and fully responsive eCommerce website
                    templates are built for speed and conversion, helping you
                    sell more with little extra effort.
                  </p>
                  <div className="ratings">
                    <span>
                      <svg
                  ...
                  <div className="testimonial-info">
                    ...
                    <div className="testimonial-info-details">
                      ...
                      <p className="testimonial-title">
                        Developer of{" "}
                        <span className="title-inner">DesginUX</span>
                      </p>
                    </div>
                  </div>
                </div>
